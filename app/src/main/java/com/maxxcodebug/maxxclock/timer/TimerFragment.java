...
import static com.maxxcodebug.maxxclock.settings.PreferencesDefaultValues.TIMER_CREATION_VIEW_SPINNER_STYLE;
...
import com.maxxcodebug.maxxclock.databinding.TimerFragmentBinding;
...
public final class TimerFragment extends DeskClockFragment implements RunnableFragment {
    ...
    private static final String EXTRA_TIMER_SETUP = "com.maxxcodebug.maxxclock.action.TIMER_SETUP";
