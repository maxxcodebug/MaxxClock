...
public final class TimerService extends Service {
     ...
     */
    public static final String EXTRA_TIMER_ID = "com.maxxcodebug.maxxclock.extra.TIMER_ID";
    private static final String ACTION_PREFIX = "com.maxxcodebug.maxxclock.action.";
