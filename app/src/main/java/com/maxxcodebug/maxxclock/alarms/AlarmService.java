...
public class AlarmService extends Service {
     ...
     * ALARM_DONE_ACTION).
     */
    public static final String ALARM_SNOOZE_ACTION = "com.maxxcodebug.maxxclock.ALARM_SNOOZE";
     ...
     */
    public static final String ALARM_DISMISS_ACTION = "com.maxxcodebug.maxxclock.ALARM_DISMISS";

    /**
     * A private action sent by AlarmService when the alarm has started.
     */
    private static final String ALARM_ALERT_ACTION = "com.maxxcodebug.maxxclock.ALARM_ALERT";

    /**
     * A public action sent by AlarmService when the alarm has stopped for any reason.
     */
    public static final String ALARM_DONE_ACTION = "com.maxxcodebug.maxxclock.ALARM_DONE";

    /**
     * Private action used to stop an alarm with this service.
     */
    private static final String STOP_ALARM_ACTION = "com.maxxcodebug.maxxclock.STOP_ALARM";

    /**
     * Private action used to stop an alarm with a double vibrations when the alarm is snoozed with this service.
     */
    private static final String STOP_ALARM_WITH_DOUBLE_VIBRATION_ACTION = "com.maxxcodebug.maxxclock.STOP_ALARM_WITH_DOUBLE_VIBRATION";

    /**
     * Private action used to stop an alarm with a single vibration when the alarm is dismissed with this service.
     */
    private static final String STOP_ALARM_WITH_SINGLE_VIBRATION_ACTION = "com.maxxcodebug.maxxclock.STOP_ALARM_WITH_SINGLE_VIBRATION";
